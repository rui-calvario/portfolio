...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		axios.post('https://sheet.best/api/sheets/5039d2d8-ccbb-49e3-9787-13e772bf110e', form).then((response) => {
			...
			<div className='contact__container container grid'>
				<div className='contact__content'>
					<div className='contact__card'>
						...
						<p className='contact__card-data'>Meyersdal, Alberton, Gauteng</p>
					</div>
					...
					<div className='contact__card'>
						...
						<p className='contact__card-data'>ruic7777@gmail.com</p>
					</div>
					...
					<div className='contact__card'>
						...
						<p className='contact__card-data'>+27 82 334 7522</p>
					</div>
				</div>
